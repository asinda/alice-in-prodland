...
export default function EditLesson({ params }: { params: Promise<{ id: string; lessonId: string }> }) {
    ...
    <>
      <div className={styles.pageHeader}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <Link href={`/admin/cours/${id}`} className={styles.btnSecondary}>← Cours</Link>
          <form action={actionDeleteLesson.bind(null, id, lessonId)}>
